...
class BAM_ChannelGate(nn.Module):
...
class BAM_SpatialGate(nn.Module):
...
class BAM(nn.Module):
    def __init__(self, gate_channel):
        ...
        self.channel_att = BAM_ChannelGate(gate_channel)
        self.spatial_att = BAM_SpatialGate(gate_channel)
    def forward(self,in_tensor):
...
class CBAM(nn.Module):
    def __init__(self, gate_channels, reduction_ratio=16, pool_types=['avg', 'max'], no_spatial=False):
        ...
        self.ChannelGate = CBAM_ChannelGate(gate_channels, reduction_ratio, pool_types)
