# encoding: utf-8
"""
Attention-based DenseNet for abnormality detection of ChestXRay in CVTE.
Author: Jason.Fang
Update time: 31/12/2020
"""
import sys
import re
import numpy as np
...
class CVTEDRNet(nn.Module):
    def __init__(self, num_classes, is_pre_trained=True):
        ...
        #simple model
        #self.conv = nn.Sequential(nn.Conv2d(3, 8, kernel_size=3, padding=1, bias=False),nn.AdaptiveAvgPool2d(7))
        #self.classifier = nn.Sequential(nn.Linear(8, num_classes), nn.Sigmoid())
