...
#self-defined
from ChestXRay8 import get_train_dataloader, get_validation_dataloader, get_test_dataloader, get_train_dataloader_disease
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        with torch.autograd.no_grad():
            for batch_idx, (image, label) in enumerate(dataloader_val):
                ...
                loss_tr = tl_criterion(var_feat, var_label)
