...
parser.add_argument('--model', type=str, default='DenseNet', help='ResNet, DenseNet, SEDenset')
...
def Train():
    ...
    model = nn.parallel.DistributedDataParallel(model, find_unused_parameters=True) #single CPU and multi GPU
